...
public class BallSpawnerBlack : MonoBehaviour
{
    ...
    private void SpawnBall()
    {
        ...
        if (availableSpawnPoints.Count > 0)
        {
            ...
            ballList.Add(ball);
            ball.GetComponent<BlackBall>().SetSpawner(this);
            ball.GetComponent<BlackBall>().spawnPoint = spawnPoint;
    ...
    public void RemoveBallFromList (GameObject ball)
    {
        ...
        BlackBall blackBallScript = ball.GetComponent<BlackBall>();
        if (blackBallScript != null && blackBallScript.spawnPoint != null)
        {
            spawnPointOccupied[blackBallScript.spawnPoint] = false;
        }
